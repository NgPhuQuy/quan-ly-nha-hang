    ...
    <div className="mx-auto max-w-2xl">
      <div className="mb-6 text-center">
        ...
        <p className="mt-2 text-sm" style={{ color: "rgba(240,216,144,.42)" }}>
          Booking reference:{" "}
          <b style={{ color: "rgba(232,184,75,.95)" }}>{bookingCode}</b>
        </p>
      </div>
      <div className="card-warm rounded-2xl p-5 sm:p-7">
        <div className="grid grid-cols-2 gap-5 text-sm">
          <div>
            <span className="block text-xs opacity-40">Branch</span>
            {branch?.ten}
          </div>
          <div>
            <span className="block text-xs opacity-40">Time</span>
            {time}
          </div>
          <div>
            <span className="block text-xs opacity-40">Date</span>
            {date}
          </div>
          <div>
            <span className="block text-xs opacity-40">Guests</span>
            {guestCount}
          </div>
          <div>
            <span className="block text-xs opacity-40">Guest name</span>
            {guestDetails.hoTen}
          </div>
          <div>
            <span className="block text-xs opacity-40">Phone</span>
            {guestDetails.soDienThoai}
          </div>
        </div>
        <div
      ...
      <div className="mt-5 flex gap-3">
        <button onClick={onReset} className="btn-ghost flex-1 rounded-xl py-3">
