...
export default function Sidebar({ active, onNavigate }) {
  ...
  >
    ...
    /* Logo */
      ...
      <div style={{ padding: "20px 20px 12px", borderBottom: "1px solid #f0ece3" }}>
  ...
  >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
              ...
              <path d="M20 3H4v10c0 3.87 3.13 7 7 7h2c3.87 0 7-3.13 7-7V3zm-5 3h2v7h-2V6zm-6 0h2v7H9V6z" fill="white" />
            </svg>
          </div>
          <div>
            <div style={{ fontSize: 13, fontWeight: 700, color: "#2c1a0e", lineHeight: 1.2 }}>Restaurant</div>
            <div style={{ fontSize: 11, fontWeight: 500, color: "#c9922a", lineHeight: 1.2, letterSpacing: "0.05em" }}>ADMIN</div>
          </div>
        </div>
      </div>
    ...
    /* Bottom: admin info + logout */
      ...
      <div style={{ padding: "12px 12px 16px", borderTop: "1px solid #f0ece3" }}>
        <div
    style={{
      display: "flex",
      alignItems: "center",
  ...
  >
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ fontSize: 13, fontWeight: 600, color: "#2c1a0e", lineHeight: 1.2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
              Admin Hệ thống
            </div>
            <div style={{ fontSize: 11, color: "#7a6248", lineHeight: 1.4 }}>Quản trị viên</div>
          </div>
        </div>
        <button
    style={{
...
function IconLogout() {
  return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
