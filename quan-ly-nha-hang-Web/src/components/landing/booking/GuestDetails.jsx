...
function GuestDetails({
  ...
  const validateForm = () => {
    ...
    if (!guestDetails.hoTen.trim())
      validationErrors.hoTen = "Please enter your full name";
    if (!/^((0|\+84)[0-9]{8,10})$/.test(guestDetails.soDienThoai.trim()))
      validationErrors.soDienThoai = "Please enter a valid phone number";
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <select
            ...
            onChange={(event) => updateField("dip", event.target.value)}
          >
