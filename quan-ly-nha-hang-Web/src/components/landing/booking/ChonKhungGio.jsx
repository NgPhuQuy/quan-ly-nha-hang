    ...
    <div className="rounded-3xl p-5 sm:p-8 bg-black/40 border border-amber-500/20 backdrop-blur-md shadow-2xl space-y-6">
      ...
      <div className="pt-6 border-t border-amber-500/20 flex items-center gap-3">
        <button
          type="button"
          onClick={onQuayLai}
          className="px-6 py-3.5 rounded-2xl border border-white/15 text-amber-200/80 hover:text-amber-100 hover:bg-white/5 text-xs sm:text-sm font-semibold flex items-center justify-center gap-2 transition-colors cursor-pointer"
        >
          <ArrowLeft size={16} />
          <span>Quay lại</span>
        </button>
        ...
        <button
          ...
          className="flex-1 btn-primary rounded-2xl py-3.5 text-xs sm:text-sm font-bold flex items-center justify-center gap-2 shadow-xl shadow-amber-900/40 disabled:opacity-50 hover:scale-[1.01] transition-transform cursor-pointer"
        >
