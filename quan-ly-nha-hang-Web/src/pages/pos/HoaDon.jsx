...
import { mockInvoices, formatCurrency } from "../../data/posMock";
const statusColor = {
...
const PAGE_SIZE = 8;
export default function HoaDon({ onNavigate, onSelectInvoice }) {
  ...
  const selectStyle =
    "text-sm border rounded-lg px-3 py-1.5 outline-none focus:ring-2 focus:ring-[var(--primary)] bg-white";
  return (
          ...
          <thead style={{ background: "var(--secondary)" }}>
            <tr>
              {[
                ...
                <th
                  key={h}
                  className="px-4 py-3 text-left text-xs font-600"
                  style={{ color: "var(--muted-foreground)" }}
                >
                  {h}
                </th>
