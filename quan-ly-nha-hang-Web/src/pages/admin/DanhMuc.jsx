...
import { categories as initialCategories } from "../../data/adminMock";
          ...
          >
            {items.map((c) => (
              <Tr key={c.id}>
                ...
                <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", verticalAlign: "middle" }}>{c.description}</td>
                <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", verticalAlign: "middle" }}>
