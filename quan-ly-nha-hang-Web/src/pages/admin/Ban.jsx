...
import { tables as initialTables, branches } from "../../data/adminMock";
            ...
            >
              {paged.map((t) => (
                <Tr key={t.id}>
                  ...
                  <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", verticalAlign: "middle" }}>{t.branch}</td>
                  <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", verticalAlign: "middle" }}>
                    <span
                      style={{
