...
import { invoices as initialInvoices } from "../../data/adminMock";
  ...
  return (
    <div style={{ padding: "28px 32px" }}>
      <PageHeader
        ...
        subtitle="Tất cả hóa đơn từ mọi chi nhánh"
      />
      <Card>
        <div
          style={{
        ...
        <div style={{ marginTop: 12 }}>
          {paged.length === 0 ? (
            ...
            >
              {paged.map((inv) => (
                <Tr key={inv.id}>
                  <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", fontFamily: "'DM Mono', monospace", verticalAlign: "middle" }}>{inv.id}</td>
                  <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", verticalAlign: "middle" }}>{inv.branch}</td>
                  <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", fontFamily: "'DM Mono', monospace", verticalAlign: "middle" }}>{inv.time}</td>
                  <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", verticalAlign: "middle" }}>
                    <span
                      style={{
                        ...
                        color: inv.source === "ONLINE" ? "#1d4ed8" : "#7a6248",
                      }}
                    >
                      {inv.source}
                    </span>
      ...
      {viewItem && (
        <Modal
          ...
          title={`Chi ti\u1EBFt h\xF3a \u0111\u01A1n ${viewItem.id}`}
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {[
              ...
              [
                "T\u1ED5ng ti\u1EC1n",
                viewItem.total.toLocaleString("vi-VN") + " \u0111",
              ],
            ].map(([label, value]) => (
              <div
                key={label}
              ...
              >
                <span style={{ fontSize: 13.5, color: "#7a6248" }}>
                  {label}
                </span>
                <span
                  style={{ fontSize: 13.5, fontWeight: 600, color: "#2c1a0e" }}
                >
                  {value}
                </span>
              </div>
