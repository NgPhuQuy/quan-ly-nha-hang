...
import { branches as initialBranches } from "../../data/adminMock";
            ...
            >
              {paged.map((b) => (
                <Tr key={b.id}>
                  ...
                  <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", verticalAlign: "middle" }}>{b.address}</td>
                  <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", fontFamily: "'DM Mono', monospace", verticalAlign: "middle" }}>{b.phone}</td>
                  <td style={{ padding: "11px 16px", fontSize: 13.5, color: "#2c1a0e", borderBottom: "1px solid #f0ece3", verticalAlign: "middle" }}>
